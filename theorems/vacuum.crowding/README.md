...
| theory | answer |
|---|---|
| `G` | \rho at R = \text{the } \rho \text{ where } DEG·\nu·\paren{1 - \paren{1 - \paren{1 - \paren{\rho + \frac{\nu·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \sigma·\rho}^{\frac{m}{A}}}·R^{-\paren{D - 1}}·\paren{n_f + 1}}{\sigma·\rho}}}^(DEG)}} - 2·F·\sigma·\paren{\rho + \frac{\nu·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \sigma·\rho}^{\frac{m}{A}}}·R^{-\paren{D - 1}}·\paren{n_f + 1}}{\sigma·\rho}}^(2) = 0 |
...
```
the body's carriers where the far one is: n = \frac{\nu·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \sigma·\rho}^{\frac{m}{A}}}·R^{-\paren{D - 1}}·\paren{n_f + 1}}{\sigma·\rho}
