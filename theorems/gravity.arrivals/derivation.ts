 ...
 *
 * gravity.arrivals, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * g_{N} \aside{in bodies and transport} = \bar{m}·\bar{m}'·\bar{r}^{-\paren{D - 1}}·\paren{T_{vac} + \mathcal{D}·\mathcal{D}'·\paren{2·\bar{r}^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\bar{r}} + 1}}
 *
...
export const THEOREM = "gravity.arrivals";
export const ASKS = "what does a body actually have DELIVERED to it - rays absorbed and meetings had?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
