...
| theory | answer |
|---|---|
| `G` | g_N in full = m'·R^{-\paren{D - 1}}·\paren{\frac{DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}} |

## G

### the result

**g_N in full = m'·R^{-\paren{D - 1}}·\paren{\frac{DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}**
...
c̄ = 1
F = \frac{1}{2}
g_N = m'·R^{-\paren{D - 1}}·\paren{\frac{DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}
```
