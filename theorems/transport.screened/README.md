...
| theory | answer |
|---|---|
| `G` | T_vac \aside{at} D \aside{= 3} = 2·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(r̄) |

## G

### the result

**T_vac \aside{at} D \aside{= 3} = 2·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(r̄)**
...
**T_vac \aside{at} D \aside{= 3} = \frac{\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(r̄)}{\omega}**  
<sub>theorem · the bodies, the separation, and what carries between them</sub>  
