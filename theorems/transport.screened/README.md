...
> a shortfall spreads out from a body and is damped as it goes. With the two bodies and the shell they share divided out, what is left of the journey?
...
| theory | answer |
|---|---|
| `G` | T_vac \aside{at} D \aside{= 3} = n_f + 1 |

## G

### the result

**T_vac \aside{at} D \aside{= 3} = n_f + 1**
...
**T_vac \aside{at} D \aside{= 3} = \frac{\paren{n_f + 1}}{\omega}**  
<sub>theorem · the bodies, the separation, and what carries between them</sub>  
