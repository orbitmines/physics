 ...
 *
 * transport.screened, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * T_{vac} \aside{at} D \aside{= 3} = 2·\paren{n_{f} + 1}
 *
...
export const THEOREM = "transport.screened";
export const ASKS = "a shortfall spreads out from a body and is damped as it goes. With the two bodies and the shell they share divided out, what is left of the journey?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "the screened transport in three dimensions"
      }
    ],
    "measured": []
  }
