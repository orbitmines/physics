...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "the meetings channel is one body's radiation meeting the other'"
      },
      {
        "kind": "var",
        "of": [
