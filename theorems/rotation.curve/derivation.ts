 ...
 *
 * rotation.curve, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * v^{2} as one equation in full = \bar{r}·\paren{\text{the } g \text{ where } g = \bar{m}·\bar{m}'·\bar{r}^{-\paren{D - 1}}·\paren{T_{vac} + \mathcal{D}·\mathcal{D}'·\paren{2·\bar{r}^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\bar{r}} + 1}}·\paren{\frac{a_{0}}{g} + 1}}
 *
...
export const THEOREM = "rotation.curve";
export const ASKS = "a body goes round at a radius. What speed does the circle need - and what decides whether that speed falls off or does not?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "because": [
      ...
      {
        "kind": "text",
        "text": "), with the arrival written ONCE. Solving it is a quadratic and the answer is the line below; this is the line the rules give, and it is the one a reader can hold"
      }
    ],
    "measured": []
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "the same circle read against the equation the rules give rather than against its solution - so the arrival appears once here and twice there, and the two say the same thing"
      }
    ],
    "measured": []
  },
