...
| theory | answer |
|---|---|
| `G` | the deficit in recession = \frac{1}{\rho}·4·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r̄·\ln\paren{1 - \frac{1}{L}}} |

## G

### the result

**the deficit in recession = \frac{1}{\rho}·4·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r̄·\ln\paren{1 - \frac{1}{L}}}**
...
**recession = \paren{\nu·\paren{1 - \rho}^(DEG) + \sigma·\paren{1 - \omega}·\rho - \sigma·\omega·\rho^(2)}·r̄**  
...
**the deficit in recession = \frac{1}{\sigma·\omega^(2)·\rho}·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r̄·\ln\paren{1 - \frac{1}{L}}}**  
<sub>theorem · and a body makes less of it, so they are carried apart more slowly</sub>  

```
recession = \paren{\nu·\paren{1 - \rho}^(DEG) + \sigma·\paren{1 - \omega}·\rho - \sigma·\omega·\rho^(2)}·r̄
the shortfall at each point is the body's own, carried: \frac{1}{\sigma·\omega·\rho·\omega}·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·r^{-\paren{D - 1}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(r)
far out that comes to \frac{1}{\sigma·\omega^(2)·\rho}·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·r^{-\paren{D - 1}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(r)
\int of that dr = -\frac{1}{\sigma·\omega^(2)·\rho}·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r·\ln\paren{1 - \frac{1}{L}}}
the deficit in recession = \frac{1}{\sigma·\omega^(2)·\rho}·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r̄·\ln\paren{1 - \frac{1}{L}}}
```
