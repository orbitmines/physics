...
| theory | answer |
|---|---|
| `G` | the deficit in recession = \frac{4·\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r̄·\ln\paren{1 - \frac{1}{L}}}}{\rho} |

## G

### the result

**the deficit in recession = \frac{4·\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r̄·\ln\paren{1 - \frac{1}{L}}}}{\rho}**
...
**the deficit in recession = \frac{\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r̄·\ln\paren{1 - \frac{1}{L}}}}{\sigma·\omega^(2)·\rho}**  
<sub>theorem · and a body makes less of it, so they are carried apart more slowly</sub>  

```
recession = \paren{\nu·\paren{1 - \rho}^(DEG) + \sigma·\paren{1 - \omega}·\rho - \sigma·\omega·\rho^(2)}·r̄
the shortfall at each point is the body's own, carried: \frac{\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·r^{-\paren{D - 1}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(r)}{\sigma·\omega·\rho·\omega}
far out that comes to \frac{\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·r^{-\paren{D - 1}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(r)}{\sigma·\omega^(2)·\rho}
\int of that dr = -\frac{\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r·\ln\paren{1 - \frac{1}{L}}}}{\sigma·\omega^(2)·\rho}
the deficit in recession = \frac{\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{2 - D, -r̄·\ln\paren{1 - \frac{1}{L}}}}{\sigma·\omega^(2)·\rho}
```
