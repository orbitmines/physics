...
**recession = \paren{\nu·n_f·\paren{1 - \rho} + \sigma·\paren{1 - \omega}·\rho + 2·\sigma·F·n̄^(2) + 2·\sigma·F·\paren{1 - \rho}·\rho^(2) - \sigma·F·\rho^(2)}·r̄**  
<sub>theorem · space is made between them, and there is more of it the further apart they are</sub>  

```
\partial_ts = \nu·n_f·\paren{1 - \rho} + \sigma·\paren{1 - \omega}·\rho + 2·\sigma·F·n̄^(2) + 2·\sigma·F·\paren{1 - \rho}·\rho^(2) - \sigma·F·\rho^(2), every term of the space line
