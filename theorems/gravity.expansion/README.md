...
**the space line nets = \nu·\paren{1 - \rho} + \sigma·\paren{1 - \omega}·\rho - \sigma·F·\rho^(2)**  
...
**recession = \paren{\nu·\paren{1 - \rho} + \sigma·\paren{1 - \omega}·\rho - \sigma·F·\rho^(2)}·r̄**  
<sub>theorem · space is made between them, and there is more of it the further apart they are</sub>  

```
\partial_ts = \nu·\paren{1 - \rho} + \sigma·\paren{1 - \omega}·\rho - \sigma·F·\rho^(2), every term of the space line
