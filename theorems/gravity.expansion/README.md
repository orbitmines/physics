...
| theory | answer |
|---|---|
| `G` | the deficit in recession = \frac{\nu·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \sigma·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^(2 - D)·\Gamma\paren{1 - \paren{D - 1}, \frac{R}{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}}}{\sigma·\rho} |
...
**the space line nets = \nu·\paren{1 - \paren{1 - \paren{1 - \rho}^(DEG)}} + \sigma·\rho - \sigma·\rho^(2)**  
<sub>theorem · the line</sub>  

```
CREATION: \nu\paren{1 - \rho} into space 1
MOVEMENT, ANNIHILATION: \sigma n\tilde{n} into space -1
MOVEMENT: \sigma n into space 1
```
...
```
\partial_ts = \nu·\paren{1 - \paren{1 - \paren{1 - \rho}^(DEG)}} + \sigma·\rho - \sigma·\rho^(2), every term of the space line
