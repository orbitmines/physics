 ...
 *
 * the deficit in recession = \frac{1}{\rho}·4·\paren{1 - \beta}·\Sigma_{0}·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^{\bar{R}}}·\paren{n_{f} + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^{2 - D}·\Gamma\paren{2 - D, -\bar{r}·\ln\paren{1 - \frac{1}{L}}}
 *
