 ...
 *
 * the deficit in recession = \frac{\nu·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \sigma·\rho}^{\frac{m}{A}}}·\paren{n_{f} + 1}·\paren{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}^{2 - D}·\Gamma\paren{1 - \paren{D - 1}, \frac{R}{-\frac{1}{\ln\paren{1 - \frac{1}{L}}}}}}{\sigma·\rho}
 *
