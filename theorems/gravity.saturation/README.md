...
| theory | answer |
|---|---|
| `G` | m̄ = \lim_R \to \infty m̄\paren{R̄} = \frac{l.choose\paren{m̄_{x\cdot l.DEG\cdot\paren{1 - \beta}}}·\paren{1 - \rho}}{\sigma·F·\rho} |

## G

### the result

**m̄ = \lim_R \to \infty m̄\paren{R̄} = \frac{l.choose\paren{m̄_{x\cdot l.DEG\cdot\paren{1 - \beta}}}·\paren{1 - \rho}}{\sigma·F·\rho}**
