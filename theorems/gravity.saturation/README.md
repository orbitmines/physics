...
| theory | answer |
|---|---|
| `G` | m̄ = \lim_R \to \infty m̄\paren{R̄} = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\paren{1 - \rho}}{\sigma·F·\rho} |

## G

### the result

**m̄ = \lim_R \to \infty m̄\paren{R̄} = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\paren{1 - \rho}}{\sigma·F·\rho}**
...
**m̄\paren{R̄} = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\paren{1 - \rho}·R̄^(D - 1)·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho·l.shell\paren{R̄}}**  
