...
| theory | answer |
|---|---|
| `G` | F_g in full = m'·\paren{\frac{\frac{1}{2}·DEG·\paren{1 - \rho}·A·\paren{\delta·R^{-\paren{D - 1}} + \sqrt{\delta^(2)·R^(2 - 2·D) + 4·\delta·R^{-\paren{D - 1}}·\rho}}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·R^{-\paren{D - 1}}·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1} + \frac{\paren{1 - \rho}·A·R^{-\paren{D - 2}}}{\rho}} |
