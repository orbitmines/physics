...
| theory | answer |
|---|---|
| `G` | F_g at D = 3 = \frac{1}{2}·g_N + \sqrt{\frac{1}{4}·g_N^(2) + g_N·a_0} |

## G

### the result

**F_g at D = 3 = \frac{1}{2}·g_N + \sqrt{\frac{1}{4}·g_N^(2) + g_N·a_0}**
...
g_N = \frac{m'·\paren{\frac{DEG·\nu·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \sigma·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\sigma·\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{\frac{2·\sigma·F}{c̄} + \frac{4·\ln\paren{\frac{R}{c̄}}}{R}}}}{R^(2)}
```
