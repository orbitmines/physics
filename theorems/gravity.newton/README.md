...
| theory | answer |
|---|---|
| `G` | F_g at D = 3 as one equation = \text{the } g \text{ where } g = \frac{1}{R^(2)}·m'·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{\frac{4·\ln\paren{R}}{R} + 1}}·\paren{\frac{a_0}{g} + 1} |

## G

### the result

**F_g at D = 3 as one equation = \text{the } g \text{ where } g = \frac{1}{R^(2)}·m'·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{\frac{4·\ln\paren{R}}{R} + 1}}·\paren{\frac{a_0}{g} + 1}**
...
**F_g as one equation in full = \text{the } g \text{ where } g = m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·\paren{\frac{a_0}{g} + 1}**  
...
\omega = \frac{1}{2}
F = \frac{1}{2}
F_g as one equation = \text{the } g \text{ where } g = m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·\paren{\frac{a_0}{g} + 1}
```
...
**F_g at D = 3 as one equation = \text{the } g \text{ where } g = \frac{1}{R^(2)}·m'·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{\frac{4·\ln\paren{R}}{R} + 1}}·\paren{\frac{a_0}{g} + 1}**  
<sub>theorem · and the same law in three dimensions</sub>  

```
\text{the } g \text{ where } g = m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·\paren{\frac{a_0}{g} + 1}
D = 3
```
