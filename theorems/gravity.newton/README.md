...
| theory | answer |
|---|---|
| `G` | F_g at D = 3 = m'·\paren{\frac{\frac{1}{2}·DEG·\paren{1 - \rho}·A·\paren{\frac{\delta}{R^(2)} + \sqrt{\frac{\delta^(2)}{R^(4)} + \frac{4·\delta·\rho}{R^(2)}}}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + \frac{m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{\frac{4·\ln\paren{R}}{R} + 1}}{R^(2)} + \frac{\paren{1 - \rho}·A}{\rho·R}} |

## G

### the result

**F_g at D = 3 = m'·\paren{\frac{\frac{1}{2}·DEG·\paren{1 - \rho}·A·\paren{\frac{\delta}{R^(2)} + \sqrt{\frac{\delta^(2)}{R^(4)} + \frac{4·\delta·\rho}{R^(2)}}}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + \frac{m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{\frac{4·\ln\paren{R}}{R} + 1}}{R^(2)} + \frac{\paren{1 - \rho}·A}{\rho·R}}**
...
F_g = m'·\paren{\frac{\frac{1}{2}·DEG·\paren{1 - \rho}·A·\paren{\delta·R^{-\paren{D - 1}} + \sqrt{\delta^(2)·R^(2 - 2·D) + 4·\delta·R^{-\paren{D - 1}}·\rho}}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·R^{-\paren{D - 1}}·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1} + \frac{\paren{1 - \rho}·A·R^{-\paren{D - 2}}}{\rho}}
D = 3
F_g = m'·\paren{\frac{\frac{1}{2}·DEG·\paren{1 - \rho}·A·\paren{\frac{\delta}{R^(2)} + \sqrt{\frac{\delta^(2)}{R^(4)} + \frac{4·\delta·\rho}{R^(2)}}}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + \frac{m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{\frac{4·\ln\paren{R}}{R} + 1}}{R^(2)} + \frac{\paren{1 - \rho}·A}{\rho·R}}
and what it cites, in three dimensions:
g_N = m'·\paren{\frac{\frac{1}{2}·DEG·\nu·\paren{1 - \rho}·A·\paren{\frac{\delta}{R^(2)} + \sqrt{\frac{\delta^(2)}{R^(4)} + \frac{4·\delta·\sigma·\rho}{R^(2)}}}·\paren{1 - \frac{1}{L}}^(R)}{\sigma·\rho} + \frac{m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{\frac{2·\sigma·F}{c̄} + \frac{4·\ln\paren{\frac{R}{c̄}}}{R}}}{R^(2)} + \frac{\nu·\paren{1 - \rho}·A}{\sigma·\rho·R}}
```
