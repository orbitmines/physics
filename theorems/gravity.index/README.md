...
| theory | answer |
|---|---|
| `G` | N in r = \frac{1}{\frac{-2·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·r^{-\paren{D - 2}}}{\rho} + 1} |

## G

### the result

**N in r = \frac{1}{\frac{-2·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·r^{-\paren{D - 2}}}{\rho} + 1}**
...
**N in r = \frac{1}{1 - \frac{\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·r^{-\paren{D - 2}}}{\sigma·\omega·\rho}}**  
<sub>theorem · substituting</sub>  

```
N = \frac{1}{1 - \delta n_f}
\delta n_f = \frac{\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·r^{-\paren{D - 2}}}{\sigma·\omega·\rho}
N = \frac{1}{1 - \frac{\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·r^{-\paren{D - 2}}}{\sigma·\omega·\rho}}
```
