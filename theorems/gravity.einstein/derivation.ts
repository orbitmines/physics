...
export const THEOREM = "gravity.einstein";
export const ASKS = "and the metric in terms of that potential - does it come out as general relativity writes it?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
