...
**F_g in full = \frac{2·a_0}{\sqrt{\frac{4·a_0}{m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \frac{\paren{1 - \beta}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}{1 - \beta\cdot\hat{d}}}} + 1} - 1}**  
...
F_g = \frac{2·a_0}{\sqrt{\frac{4·a_0}{m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \frac{\paren{1 - \beta}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}{1 - \beta\cdot\hat{d}}}} + 1} - 1}
```
