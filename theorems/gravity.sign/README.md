...
> two channels could in principle oppose. Can anything a body does make this law push rather than pull - a second body moving away, for instance?
...
**F_g in full = \frac{2·a_0}{\sqrt{\frac{4·a_0}{m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}} + 1} - 1}**  
...
c̄ = 1
F = \frac{1}{2}
F_g = \frac{2·a_0}{\sqrt{\frac{4·a_0}{m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}} + 1} - 1}
```
...
<sub>theorem · what one action a tick does to a moving body</sub>  
...
**the sign of the force = 1**  
<sub>theorem · whether any of it can turn negative</sub>  

```
motion contributes \paren{1 - \beta}^(2)
...
so F_g > 0 always - it weakens with motion and never reverses
```
