...
**F_g in full = \frac{2·a_0}{\sqrt{\frac{4·a_0}{m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}} + 1} - 1}**  
...
\omega = \frac{1}{2}
F = \frac{1}{2}
F_g = \frac{2·a_0}{\sqrt{\frac{4·a_0}{m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}} + 1} - 1}
```
...
```
what a body puts out: \paren{1 - \beta}·\Sigma_0
