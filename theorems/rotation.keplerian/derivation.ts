 ...
 *
 * rotation.keplerian, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * v^{2} where the arrival dominates in full = \bar{r}·\bar{m}·\bar{m}'·\bar{r}^{-\paren{D - 1}}·\paren{T_{vac} + \mathcal{D}·\mathcal{D}'·\paren{2·\bar{r}^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\bar{r}} + 1}}
 *
...
export const THEOREM = "rotation.keplerian";
export const ASKS = "where what arrives is far above the scale, what does the curve do?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const CONCLUDED: Piece[] = [
  ...
  {
    "kind": "text",
    "text": " where the arrival dominates in full = "
  },
  {
    "kind": "bar",
    "of": [
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "line": [
      ...
      {
        "kind": "text",
        "text": " where the arrival dominates = "
      },
      {
        "kind": "bar",
        "of": [
    ...
    "because": [
      {
        "kind": "text",
        "text": "where what arrives is far above the scale the law gives back the arrival itself, so the curve is "
      },
      {
        "kind": "bar",
        "of": [
      ...
      {
        "kind": "text",
        "text": " times it. What arrives is diluted over the room a shell has, which in three dimensions is an inverse square, so this falls as one over the radius and the speed as its root - Kepler, with nothing added"
      }
    ],
    "measured": []
  },
