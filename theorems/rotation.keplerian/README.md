...
> where what arrives is far above the scale, what does the curve do?
...
| theory | answer |
|---|---|
| `G` | v^(2) where the arrival dominates in full = r̄·m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}} |

## G

### the result

**v^(2) where the arrival dominates in full = r̄·m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}**
...
**v^(2) where the arrival dominates = r̄·g_N**  
<sub>theorem · the two ends a rotation curve has</sub>  

```
g -> g_N
v^(2) = r̄·g_N
and g_N goes as R^(-(D-1)), so v^(2) goes as R^(2-D) - inverse R at D = 3
```
...
c̄ = 1
F = \frac{1}{2}
v^(2) where the arrival dominates = r̄·m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}
```
