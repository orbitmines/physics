...
| theory | answer |
|---|---|
| `G` | v^(2) where the arrival dominates in full = r̄·m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \frac{\paren{1 - \beta}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}{1 - \beta\cdot\hat{d}}} |

## G

### the result

**v^(2) where the arrival dominates in full = r̄·m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \frac{\paren{1 - \beta}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}{1 - \beta\cdot\hat{d}}}**
...
v^(2) where the arrival dominates = r̄·m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \frac{\paren{1 - \beta}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}{1 - \beta\cdot\hat{d}}}
```
