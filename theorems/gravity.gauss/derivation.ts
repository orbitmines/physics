...
export const THEOREM = "gravity.gauss";
export const ASKS = "general relativity has a flux law behind it. Do these rules give one, and is it the same one?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
