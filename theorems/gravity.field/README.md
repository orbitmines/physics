...
**\delta n_f = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}·r^{-\paren{D - 2}}}{\sigma·F·\rho}**  
...
```
the record a body adds is \delta n_f = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}·r^{-\paren{D - 2}}}{\sigma·F·\rho}
