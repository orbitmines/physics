 ...
 *
 * gravity.field, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * the field equation = 1 - \paren{1 - \Phi}^{2}
 *
...
export const THEOREM = "gravity.field";
export const ASKS = "Einstein's equation relates the curvature to the source. Do these rules give that relation, and with what coupling?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "line": [
      ...
      {
        "kind": "text",
        "text": ", off the record a ray crosses = "
      },
      {
        "kind": "scripted",
        "base": {
    ...
    "working": [
      [
        {
          "kind": "text",
          "text": "the record a body adds is "
        },
        {
          "kind": "var",
          "of": [
      ...
      [
        ...
        {
          "kind": "text",
          "text": ", which is this to first order"
        }
      ]
    ],
    "because": [
      {
        "kind": "text",
        "text": "THE METRIC. `metricOf` reads it off the record a ray crosses, and that record IS the potential - the same accumulation, derived twice - so `"
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": "` are one quantity and this is that substitution. WHAT COMES OUT IS EINSTEIN'"
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": ", INCLUDING THE TWO: `metricOf` gives `"
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": "` as the SQUARE of the tick rate, because a metric coefficient multiplies `d"
      },
      {
        "kind": "scripted",
        "base": {
      ...
      {
        "kind": "text",
        "text": "` to first order. THE FACTOR OF TWO THIS MODEL WAS SHORT BY WAS A ROOT MISTAKEN FOR A COEFFICIENT, and nothing was added to fix it. What is left over is the second order term, which is a real difference from Schwarzschild's exact `1 - "
      },
      {
        "kind": "scripted",
        "base": {
      ...
      {
        "kind": "text",
        "text": "` and shows up only where the field is strong"
      }
    ],
    "measured": []
  },
  {
    ...
    "working": [
      ...
      [
        {
          "kind": "text",
          "text": "so this model is Einstein's times "
        },
        {
          "kind": "frac",
          "over": [
    ...
    "because": [
      {
        "kind": "text",
        "text": "WHAT EINSTEIN'S COUPLING HAS TO BE MULTIPLIED BY to give this model'"
      },
      {
        "kind": "var",
        "of": [
  ...
  },
  {
    ...
    "working": [
      ...
      [
        {
          "kind": "text",
          "text": "same source, same motion, half the coupling"
        }
      ]
    ],
    "because": [
      {
        "kind": "text",
        "text": "EINSTEIN'S FIELD EQUATION, in the weak static field where it is a statement about one function. `"
      },
      {
        "kind": "scripted",
        "base": {
      ...
      {
        "kind": "text",
        "text": "`: the curvature of the time part answers the mass density, with a coupling of `8"
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": "`. THESE RULES GIVE THE SAME EQUATION WITH HALF THAT COUPLING - `"
      },
      {
        "kind": "scripted",
        "base": {
      ...
      {
        "kind": "text",
        "text": "` - because the record a ray crosses enters the metric once where Einstein's potential enters twice. SO THE DIFFERENCE IS NOT IN WHAT SOURCES GRAVITY, which is the same `"
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": "` through the same Poisson equation, NOR IN HOW A BODY MOVES, which comes out as the geodesic gives it. It is one number in front, and it is a factor of two"
      }
    ],
    "measured": []
  }
