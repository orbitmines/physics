...
**what a gathered mass sends = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}**  
<sub>theorem · the same mass, gathered or scattered</sub>  

```
\paren{1-\sigma\rho}^(m/A) -> 0 as m/A grows
what is sent -> \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}
