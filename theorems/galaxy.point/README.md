...
the vacuum's channel - what the near body prevents, CARRIED as the \delta that spreads rather than multiplied onto it afterwards, over what the far one is open to:
  S = \nu·\paren{1 - \rho},  thinned \frac{\delta·r̄^{-\paren{D - 1}}·\paren{n_f + 1}}{\omega},  open to \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\omega·A'·\paren{1 - \paren{1 - \sigma·F·\rho}^{R̄'}}}{\sigma·F·\rho}
