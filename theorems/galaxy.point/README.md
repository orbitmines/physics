...
the vacuum's channel - what the near body prevents, CARRIED as the \delta that spreads rather than multiplied onto it afterwards, over what the far one is open to:
  S = \sigma·\paren{1 - \rho}·F,  thinned \frac{\delta·r̄^{-\paren{D - 1}}·\paren{n_f + 1}}{\omega},  open to \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\omega·A'·\paren{1 - \paren{1 - \sigma·F·\rho}^{R̄'}}}{\sigma·F·\rho}
...
**what a gathered mass sends = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\omega·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}**  
<sub>theorem · the same mass, gathered or scattered</sub>  

```
\paren{1-\sigma\rho}^(m/A) -> 0 as m/A grows
what is sent -> \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\omega·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}
