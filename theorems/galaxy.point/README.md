...
| theory | answer |
|---|---|
| `G` | v^(2) with the mass gathered = R·\paren{\frac{1}{2}·\paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·R^{-\paren{D - 1}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\sigma·\rho} + m·m'·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\sigma·F·R^{-\paren{D - 1}}·c̄^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^(3 - 2·D)·\ln\paren{\frac{R}{c̄}}}} + \sqrt{\frac{1}{4}·\paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·R^{-\paren{D - 1}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\sigma·\rho} + m·m'·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\sigma·F·R^{-\paren{D - 1}}·c̄^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^(3 - 2·D)·\ln\paren{\frac{R}{c̄}}}}^(2) + \paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·R^{-\paren{D - 1}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\sigma·\rho} + m·m'·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\sigma·F·R^{-\paren{D - 1}}·c̄^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^(3 - 2·D)·\ln\paren{\frac{R}{c̄}}}}·a_0}} |
...
```
v^(2) = R·F_g at the gathered arrival
```
