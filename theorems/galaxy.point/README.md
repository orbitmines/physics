...
**what a gathered mass sends = \frac{\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}**  
<sub>theorem · the same mass, gathered or scattered</sub>  

```
\paren{1-\sigma\rho}^(m/A) -> 0 as m/A grows
what is sent -> \frac{\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}
