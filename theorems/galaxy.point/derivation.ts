 ...
 *
 * galaxy.point, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * v^{2} with the mass gathered = R·\paren{\frac{1}{2}·\paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·R^{-\paren{D - 1}}·\paren{n_{f} + 1}·\paren{1 - \frac{1}{L}}^{R}}{\sigma·\rho} + m·m'·\paren{1 - \beta}^{2}·\Sigma_{0}^{2}·\paren{2·\sigma·F·R^{-\paren{D - 1}}·\bar{c}^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^{3 - 2·D}·\ln\paren{\frac{R}{\bar{c}}}}} + \sqrt{\frac{1}{4}·\paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·R^{-\paren{D - 1}}·\paren{n_{f} + 1}·\paren{1 - \frac{1}{L}}^{R}}{\sigma·\rho} + m·m'·\paren{1 - \beta}^{2}·\Sigma_{0}^{2}·\paren{2·\sigma·F·R^{-\paren{D - 1}}·\bar{c}^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^{3 - 2·D}·\ln\paren{\frac{R}{\bar{c}}}}}^{2} + \paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·R^{-\paren{D - 1}}·\paren{n_{f} + 1}·\paren{1 - \frac{1}{L}}^{R}}{\sigma·\rho} + m·m'·\paren{1 - \beta}^{2}·\Sigma_{0}^{2}·\paren{2·\sigma·F·R^{-\paren{D - 1}}·\bar{c}^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^{3 - 2·D}·\ln\paren{\frac{R}{\bar{c}}}}}·a_{0}}}
 *
...
export const THEOREM = "galaxy.point";
export const ASKS = "a galaxy taken as ONE source, the whole of its mass presenting one face. What does it send, and what curve does that give?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "because": [
      ...
      {
        "kind": "text",
        "text": "/R toward the centre and the medium is what supplies it, so the speed a circle needs is the square root of the radius times what is felt there. Nothing about galaxies is in this - it is what any orbit is, and the galaxy comes in through what `g` is at that radius"
      }
    ],
    "measured": []
  },
  ...
  },
  {
    ...
    "line": [
      {
        "kind": "text",
        "text": "what a gathered mass sends = "
      },
      {
        "kind": "frac",
        "over": [
    ...
    "working": [
      ...
      [
        {
          "kind": "text",
          "text": "and that does not mention m at all - the inside is hidden"
        }
      ]
    ],
    "because": [
      {
        "kind": "text",
        "text": "all of it in one place is many mean free paths deep behind its own face, so what gets out through that face is all of it - the factor saturates and what is sent is set by the FACE. Mass added behind it is shadowed by its own skin and sends nothing"
      }
    ],
    "measured": []
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "the circle's law read at the gathered arrival - one source, the whole of it presenting its own face, which is what a galaxy taken as a single point comes to"
      }
    ],
    "measured": []
  }
