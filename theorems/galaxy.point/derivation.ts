 ...
 *
 * v^{2} with the mass gathered as one equation in full = R·\paren{\text{the } g \text{ where } g = m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_{f} + 1}·\paren{1 - \frac{1}{L}}^{R}}{\rho} + m·\paren{1 - \beta}^{2}·\Sigma_{0}^{2}·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^{2 - D}·\ln\paren{R} + 1}}·\paren{\frac{a_{0}}{g} + 1}}
 *
...
export const CONCLUDED: Piece[] = [
  ...
  {
    "kind": "text",
    "text": " with the mass gathered as one equation in full = R·"
  },
  {
    "kind": "paren",
    "of": [
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "line": [
      ...
      {
        "kind": "text",
        "text": " with the mass gathered as one equation = R·"
      },
      {
        "kind": "paren",
        "of": [
    ...
    "because": [
      {
        "kind": "text",
        "text": "the circle read at the gathered arrival, against the equation the rules give rather than against its solution - so the arrival is written once"
      }
    ],
    "measured": []
  },
