 ...
 *
 * v^{2} with the mass gathered as one equation \aside{in bodies and transport} = \bar{r}·\paren{\text{the } g \text{ where } g = \bar{m}_{\bullet}·\bar{m}'·\bar{r}^{-\paren{D - 1}}·\paren{T_{vac} + \mathcal{D}·\mathcal{D}'·\paren{2·\bar{r}^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\bar{r}} + 1}}·\paren{\frac{a_{0}}{g} + 1}}
 *
...
export const CONCLUDED: Piece[] = [
  ...
  {
    "kind": "text",
    "text": " with the mass gathered as one equation "
  },
  {
    "kind": "muted",
    "of": [
  ...
  },
  {
    ...
    "working": [
      ...
      [
        {
          "kind": "text",
          "text": "and that does not mention "
        },
        {
          "kind": "bar",
          "of": [
        ...
        {
          "kind": "text",
          "text": " at all - the inside is hidden"
        }
      ]
    ],
    "because": [
