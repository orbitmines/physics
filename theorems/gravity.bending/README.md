...
| theory | answer |
|---|---|
| `G` | \alpha = \frac{4·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·b^{-\paren{D - 2}}}{\rho} |

## G

### the result

**\alpha = \frac{4·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·b^{-\paren{D - 2}}}{\rho}**
...
**\alpha = \frac{2·\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·b^{-\paren{D - 2}}}{\sigma·\omega·\rho}**  
<sub>theorem · the integral of the index across the path</sub>  

```
turns: 1 way straight on against folds[d] ways out along d
the fold record along the path: \frac{\paren{1 - \beta}·\Sigma_0·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R̄)}·r^{-\paren{D - 2}}}{\sigma·\omega·\rho}
