...
| theory | answer |
|---|---|
| `G` | \alpha = \frac{4·l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·b^{-\paren{D - 2}}}{\rho} |

## G

### the result

**\alpha = \frac{4·l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}·b^{-\paren{D - 2}}}{\rho}**
...
**\alpha = \frac{2·l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\omega·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}·b^{-\paren{D - 2}}}{\sigma·F·\rho}**  
<sub>theorem · the integral of the index across the path</sub>  

```
turns: 1 way straight on against folds[d] ways out along d
the fold record along the path: \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\omega·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}·r^{-\paren{D - 2}}}{\sigma·F·\rho}
the leans added up over the pass, r = \sqrt{b^(2)+s^(2)}
