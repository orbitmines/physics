 ...
 *
 * gravity.coupling, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * \kappa = \frac{\paren{1 - \paren{1 - \Phi}^{2}}}{2·\Phi}
 *
...
export const THEOREM = "gravity.coupling";
export const ASKS = "Einstein's field equation has one number in front of the source. What does this model put there instead?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
