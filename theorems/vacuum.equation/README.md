...
| theory | answer |
|---|---|
| `G` | (\partial_t + \hat{d}·\nabla_x + \paren{\nabla n_f}·\nabla_{\hat{d}})n = -\sigmaFn\tilde{n} + \nu\paren{1 - \rho^(DEG)} - \paren{1 - \beta}\Sigma + \omega·\paren{1 - \beta}\Sigma |
...
**\hat{d}·\nabla_x + \paren{\nabla n_f}·\nabla_{\hat{d}} + \partial_{t}n = \nu\paren{1 - \rho^(DEG)} + \sigma\paren{1 - \omega}n + \omega·\paren{1 - \beta}\Sigma - \sigmaFn\tilde{n} - \paren{1 - \beta}\Sigma**  
<sub>theorem · and the terms add</sub>  

```
- \sigmaFn\tilde{n}   (ANNIHILATION)
+ \nu\paren{1 - \rho^(DEG)}   (CREATION)
...
(\partial_t + \hat{d}·\nabla_x + \paren{\nabla n_f}·\nabla_{\hat{d}})n = -\sigmaFn\tilde{n} + \nu\paren{1 - \rho^(DEG)} - \paren{1 - \beta}\Sigma + \omega·\paren{1 - \beta}\Sigma
\partial_ts = -\sigmaFn\tilde{n} + \nu\paren{1 - \rho^(DEG)} + \sigma\paren{1 - \omega}n
```
