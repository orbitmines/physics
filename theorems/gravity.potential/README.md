...
> and the potential that flux implies - is it the one general relativity uses?
...
| theory | answer |
|---|---|
| `G` | \Phi = m̄·r̄^(2 - D)·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}·\paren{\frac{a_0}{recur} + 1} |

## G

### the result

**\Phi = m̄·r̄^(2 - D)·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}·\paren{\frac{a_0}{recur} + 1}**
