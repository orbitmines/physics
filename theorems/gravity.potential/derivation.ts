 ...
 *
 * gravity.potential, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * \Phi = \bar{m}·\bar{r}^{2 - D}·\paren{T_{vac} + \mathcal{D}·\mathcal{D}'·\paren{2·\bar{r}^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\bar{r}} + 1}}·\paren{\frac{a_{0}}{recur} + 1}
 *
...
export const THEOREM = "gravity.potential";
export const ASKS = "and the potential that flux implies - is it the one general relativity uses?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
