...
| theory | answer |
|---|---|
| `G` | what a body puts into the medium = \frac{2·\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}}{\rho} |

## G

### the result

**what a body puts into the medium = \frac{2·\paren{1 - \beta}·m̄_x·A·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}}{\rho}**
