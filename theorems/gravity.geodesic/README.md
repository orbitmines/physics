...
> general relativity moves a body along a geodesic of the metric. These rules hand it the momentum of what arrives. Do the two come to the same equation of motion?
...
| theory | answer |
|---|---|
| `G` | the equation of motion = m̄·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}·\paren{\frac{a_0}{recur} + 1} |

## G

### the result

**the equation of motion = m̄·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}·\paren{\frac{a_0}{recur} + 1}**
...
**the equation of motion = m̄·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·\sigma·F·c̄^{-\paren{D - 2}} + 2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\frac{r̄}{c̄}}}}·\paren{\frac{a_0}{recur} + 1}**  
<sub>theorem · general relativity's equations, off these rules</sub>  

```
a = -\nabla\Phi = m̄·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·\sigma·F·c̄^{-\paren{D - 2}} + 2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\frac{r̄}{c̄}}}}·\paren{\frac{a_0}{recur} + 1}
