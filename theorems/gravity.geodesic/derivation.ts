 ...
 *
 * gravity.geodesic, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * the equation of motion = \bar{m}·\bar{r}^{-\paren{D - 1}}·\paren{T_{vac} + \mathcal{D}·\mathcal{D}'·\paren{2·\bar{r}^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\bar{r}} + 1}}·\paren{\frac{a_{0}}{recur} + 1}
 *
...
export const THEOREM = "gravity.geodesic";
export const ASKS = "general relativity moves a body along a geodesic of the metric. These rules hand it the momentum of what arrives. Do the two come to the same equation of motion?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
  ...
  },
  {
    ...
    "working": [
      ...
      [
        {
          "kind": "text",
          "text": "general relativity: the weak field limit of the geodesic equation"
        }
      ],
      [
        {
          "kind": "text",
          "text": "these rules: momentum per tick from what arrives"
        }
      ]
    ],
    "because": [
      {
        "kind": "text",
        "text": "THE GEODESIC EQUATION, in its weak field form `"
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": "`. General relativity gets this by making a body follow a geodesic of the metric; THESE RULES GET IT WITHOUT ONE - `propel` hands a body the momentum of what arrives at it, and what arrives is the flux, so the acceleration is the gradient of the potential. Two different arguments, the same equation, and neither borrowed from the other"
      }
    ],
    "measured": []
  }
