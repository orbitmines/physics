...
export const ASKS = "every body in the world is casting a shortfall everywhere. Adding up what all of them put on you, is there a total?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "what spreads is damped as well as diluted, and the range is where the two balance - one over the root of how hard it is pushed back times how fast it forgets which way it was going"
      }
    ],
    "measured": []
  },
  {
    ...
    "working": [
      ...
      [
        {
          "kind": "text",
          "text": "a geometric sum, which comes to L = "
        },
        {
          "kind": "frac",
          "over": [
    ...
    "because": [
      ...
      {
        "kind": "text",
        "text": " in the shell cancel exactly, so a world with an unscreened field would have every shell contributing alike and no total at all - which is Olbers' paradox. What settles it here is the exponential: the sum converges, and what it converges to is set by the screening length and not by how big the world is"
      }
    ],
    "measured": []
  }
