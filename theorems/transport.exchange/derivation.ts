 ...
 *
 * transport.exchange, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * T_{met} \aside{at} D \aside{= 3} = \frac{4·\ln\paren{\bar{r}}}{\bar{r}} + 1
 *
...
export const THEOREM = "transport.exchange";
export const ASKS = "and the other route, which needs both bodies to be shining rather than one to be open - what does that carry, once the same two things are divided out?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "the exchange transport in three dimensions"
      }
    ],
    "measured": []
  }
