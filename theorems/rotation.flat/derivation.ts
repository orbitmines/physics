 ...
 *
 * rotation.flat, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * v^{2} where the scale dominates in full = \bar{r}·\sqrt{\bar{m}·\bar{m}'·\bar{r}^{-\paren{D - 1}}·\paren{T_{vac} + \mathcal{D}·\mathcal{D}'·\paren{2·\bar{r}^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\bar{r}} + 1}}·a_{0}}
 *
...
export const THEOREM = "rotation.flat";
export const ASKS = "and where the scale is far above what arrives - why does the radius drop out?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const CONCLUDED: Piece[] = [
  ...
  {
    "kind": "text",
    "text": " where the scale dominates in full = "
  },
  {
    "kind": "bar",
    "of": [
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "nothing in the line pushes "
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": "back, so the chance of surviving one step is one and the chance of surviving r of them is one. What is left at r is what spread there, and the dilution is the whole of the law"
      }
    ],
    "measured": []
  },
  ...
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "what a body puts out is the term no rewrite puts there, scaled by what its gates let through - and a body going somewhere has spent that share of its ticks moving rather than shining, which is the whole of why a moving source is shifted. AND IT IS NAMED "
      },
      {
        "kind": "scripted",
        "base": {
      ...
      {
        "kind": "text",
        "text": " BECAUSE THAT IS ITS NAME - how often per tick a source activates one direction, a fraction of "
      },
      {
        "kind": "count",
        "of": [
      ...
      {
        "kind": "text",
        "text": " here made the medium's ledger and the source's own rate look like two quantities, and every law that touched both then carried the seam between them"
      }
    ],
    "measured": []
  },
  ...
  },
  {
    ...
    "working": [
      ...
      [
        {
          "kind": "text",
          "text": "a level is the rate made times how long one lasts, not the net: "
        },
        {
          "kind": "words",
          "text": "the "
  ...
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "the accumulation runs until a meeting ends it, so the stretch is the mean free path - and what the phase counts is TICKS, so what matters is how long that path takes, which is the path over the speed. MOVEMENT turns a carrier and only lets it step where the way it drew leads somewhere, so the speed is not one cell a tick and the scale is "
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": ". It is NOT the rate space is made: that is MOVEMENT's other branch, and the two are equal only if the branches are not shared out at all"
      }
    ],
    "measured": []
  },
  {
    ...
    "line": [
      ...
      {
        "kind": "text",
        "text": " where the scale dominates = "
      },
      {
        "kind": "bar",
        "of": [
    ...
    "because": [
      {
        "kind": "text",
        "text": "and where the scale is far above what arrives the law gives their geometric mean. THE POWERS OF THE RADIUS THEN CANCEL EXACTLY: what arrives falls as an inverse square, its root falls as one over the radius, and the "
      },
      {
        "kind": "bar",
        "of": [
      ...
      {
        "kind": "text",
        "text": " in front of it undoes that - so the speed does not depend on the radius at all. A FLAT CURVE IS NOT PUT IN ANYWHERE; it is one power of "
      },
      {
        "kind": "bar",
        "of": [
