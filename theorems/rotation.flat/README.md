...
| theory | answer |
|---|---|
| `G` | v^(2) where the scale dominates in full = R·\sqrt{m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·a_0} |

## G

### the result

**v^(2) where the scale dominates in full = R·\sqrt{m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·a_0}**
...
**a_0 = \frac{\omega^(2)·\sigma·\rho}{n_f + 1}**  
<sub>theorem · the phase between the two pulses, which the body's own acceleration keeps from cancelling</sub>  
...
a_0 = v/\lambda = \frac{\omega^(2)·\sigma·\rho}{n_f + 1}
```
...
**v^(2) where the scale dominates = R·\sqrt{g_N·a_0}**  
...
\omega = \frac{1}{2}
F = \frac{1}{2}
v^(2) where the scale dominates = R·\sqrt{m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·a_0}
```
