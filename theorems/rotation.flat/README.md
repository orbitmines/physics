...
| theory | answer |
|---|---|
| `G` | v^(2) where the scale dominates in full = r̄·\sqrt{m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \frac{\paren{1 - \beta}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}{1 - \beta\cdot\hat{d}}}·a_0} |

## G

### the result

**v^(2) where the scale dominates in full = r̄·\sqrt{m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \frac{\paren{1 - \beta}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}{1 - \beta\cdot\hat{d}}}·a_0}**
...
v^(2) where the scale dominates = r̄·\sqrt{m̄·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \frac{\paren{1 - \beta}·\mathcal{D}'·\paren{2·r̄^(2 - D)·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}{1 - \beta\cdot\hat{d}}}·a_0}
```
