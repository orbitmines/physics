...
| theory | answer |
|---|---|
| `G` | v^(2) with the mass scattered as one equation in full = R·\paren{\text{the } g \text{ where } g = m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·\paren{\frac{a_0}{g} + 1}} |

## G

### the result

**v^(2) with the mass scattered as one equation in full = R·\paren{\text{the } g \text{ where } g = m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·\paren{\frac{a_0}{g} + 1}}**
...
**what a scattered mass sends = \frac{\nu·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \sigma·\omega·\rho}^{\frac{m}{A}}}}{\sigma·\omega·\rho}**  
...
the circle read at the scattered arrival, against the equation the rules give rather than against its solution - so the arrival is written once
...
\omega = \frac{1}{2}
F = \frac{1}{2}
v^(2) with the mass scattered as one equation = R·\paren{\text{the } g \text{ where } g = m'·R^{-\paren{D - 1}}·\paren{\frac{4·DEG·\paren{1 - \rho}·A·\paren{1 - \paren{1 - \frac{1}{2}·\rho}^{\frac{m}{A}}}·\paren{n_f + 1}·\paren{1 - \frac{1}{L}}^(R)}{\rho} + m·\paren{1 - \beta}^(2)·\Sigma_0^(2)·\paren{2·\binom{2·\paren{D - 2}}{D - 2}·R^(2 - D)·\ln\paren{R} + 1}}·\paren{\frac{a_0}{g} + 1}}
```
