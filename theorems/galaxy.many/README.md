...
> and the same galaxy taken as its stars, each thin enough to send all of itself. Why is that not the same answer?
...
| theory | answer |
|---|---|
| `G` | v^(2) with the mass scattered as one equation \aside{in bodies and transport} = r̄·\paren{\text{the } g \text{ where } g = m̄_\star·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}·\paren{\frac{a_0}{g} + 1}} |

## G

### the result

**v^(2) with the mass scattered as one equation \aside{in bodies and transport} = r̄·\paren{\text{the } g \text{ where } g = m̄_\star·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{r̄} + 1}}·\paren{\frac{a_0}{g} + 1}}**
...
**what a scattered mass sends = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\omega·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}**  
...
M/m_* of them: \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\omega·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}
```
...
**v^(2) with the mass scattered as one equation \aside{in bodies and transport} = r̄·\paren{\text{the } g \text{ where } g = m̄_\star·m̄'·r̄^{-\paren{D - 1}}·\paren{T_vac + \mathcal{D}·\mathcal{D}'·\paren{2·\sigma·F·c̄^{-\paren{D - 2}} + 2·r̄^{2 - D}·\binom{2·\paren{D - 2}}{D - 2}·\ln\paren{\frac{r̄}{c̄}}}}·\paren{\frac{a_0}{g} + 1}}**  
