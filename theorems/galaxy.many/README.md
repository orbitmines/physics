...
**what a scattered mass sends = \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}**  
...
M/m_* of them: \frac{l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A·\paren{1 - \paren{1 - \sigma·F·\rho}^(R̄)}}{\sigma·F·\rho}
```
