 ...
 *
 * v^{2} with the mass scattered = R·\paren{\frac{1}{2}·\paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·\paren{1 - \paren{\frac{m·\ln\paren{1 - \sigma·\rho}}{A} + 1}}·R^{-\paren{D - 1}}·\paren{n_{f} + 1}·\paren{1 - \frac{1}{L}}^{R}}{\sigma·\rho} + m·m'·\paren{1 - \beta}^{2}·\Sigma_{0}^{2}·\paren{2·\sigma·F·R^{-\paren{D - 1}}·\bar{c}^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^{3 - 2·D}·\ln\paren{\frac{R}{\bar{c}}}}} + \sqrt{\frac{1}{4}·\paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·\paren{1 - \paren{\frac{m·\ln\paren{1 - \sigma·\rho}}{A} + 1}}·R^{-\paren{D - 1}}·\paren{n_{f} + 1}·\paren{1 - \frac{1}{L}}^{R}}{\sigma·\rho} + m·m'·\paren{1 - \beta}^{2}·\Sigma_{0}^{2}·\paren{2·\sigma·F·R^{-\paren{D - 1}}·\bar{c}^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^{3 - 2·D}·\ln\paren{\frac{R}{\bar{c}}}}}^{2} + \paren{\frac{m'·DEG·\nu·\paren{1 - \rho}·A·\paren{1 - \paren{\frac{m·\ln\paren{1 - \sigma·\rho}}{A} + 1}}·R^{-\paren{D - 1}}·\paren{n_{f} + 1}·\paren{1 - \frac{1}{L}}^{R}}{\sigma·\rho} + m·m'·\paren{1 - \beta}^{2}·\Sigma_{0}^{2}·\paren{2·\sigma·F·R^{-\paren{D - 1}}·\bar{c}^{-\paren{D - 2}} + 2·\binom{2·\paren{D - 2}}{D - 2}·R^{3 - 2·D}·\ln\paren{\frac{R}{\bar{c}}}}}·a_{0}}}
 *
...
export const CONCLUDED: Piece[] = [
  ...
  {
    "kind": "text",
    "text": " with the mass scattered = R·"
  },
  {
    "kind": "paren",
    "of": [
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    "because": [
      ...
      {
        "kind": "text",
        "text": " for small x, so a star sends its own MASS by that log and its face cancels. Arrivals add, so M/"
      },
      {
        "kind": "scripted",
        "base": {
  ...
  },
  {
    ...
    "because": [
      {
        "kind": "text",
        "text": "and read at the scattered arrival - a star apiece, each thin enough to send all of itself, which is what a galaxy taken as its stars comes to"
      }
    ],
    "measured": []
  }
