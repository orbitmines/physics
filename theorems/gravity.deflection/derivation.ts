 ...
 *
 * gravity.deflection, for G on any
 * (D null, DEG null), box null, null ticks.
 *
 * the deflection this model gives = 2·r_{s}·b^{-\paren{D - 2}}
 *
...
export const THEOREM = "gravity.deflection";
export const ASKS = "the metric bends light. Written in the mass the force law fixes, by how much - and does it agree with what was measured?";
export const UNDER = {
  "theory": "G",
  "geometry": "any",
  "D": null,
...
export const CONCLUDED: Piece[] = [
  {
    "kind": "text",
    "text": "the deflection this model gives = 2·"
  },
  {
    "kind": "scripted",
    "base": {
  ...
  },
  {
    ...
    "working": [
      ...
      [
        ...
        {
          "kind": "text",
          "text": "= 2GM/b here and 4GM/b in GR - short by exactly two"
        }
      ]
    ],
    "because": [
      {
        "kind": "text",
        "text": "light follows the index and the index is the record, so the bend is twice the record at closest approach. WRITTEN IN THE MASS THE FORCE LAW FIXES this is 2GM/"
      },
      {
        "kind": "var",
        "of": [
      ...
      {
        "kind": "text",
        "text": ", which is NEWTON'S deflection - a stone's answer. General relativity gives 4GM/b and the measurement gives general relativity. The two differ by exactly two, everywhere and at every lattice, and THIS MODEL DOES NOT DERIVE THAT TWO: it would need the record to enter the metric twice over, and no rule here says it does. It is written as a mismatch because that is what it is"
      }
    ],
    "measured": []
  }
