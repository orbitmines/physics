...
> the metric bends light. Written in the mass the force law fixes, by how much - and does it agree with what was measured?
...
| theory | answer |
|---|---|
| `G` | the deflection this model gives = 2·r_s·b^{-\paren{D - 2}} |

## G

### the result

**the deflection this model gives = 2·r_s·b^{-\paren{D - 2}}**
...
```
the force law gives a = m̄/r^(2), so GM = m̄
the metric gives A = 1 - m̄/r, where GR has 1 - 2GM/r
