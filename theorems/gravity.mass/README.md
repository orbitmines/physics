...
| theory | answer |
|---|---|
| `G` | m̄\paren{R̄} = \frac{2·\paren{1 - \beta}·m̄_x·\paren{1 - \rho}·R̄^(D - 1)·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}}{\rho·l.shell\paren{R̄}} |

## G

### the result

**m̄\paren{R̄} = \frac{2·\paren{1 - \beta}·m̄_x·\paren{1 - \rho}·R̄^(D - 1)·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄)}}{\rho·l.shell\paren{R̄}}**
