...
> a source says how often it announces itself and how big it is, and nothing else. What is it worth to everything around it?
...
| theory | answer |
|---|---|
| `G` | m̄\paren{R} = \frac{l.choose\paren{m̄_x·l.DEG}·\paren{1 - \rho}·R^(D - 1)·\paren{1 - \paren{1 - \sigma·\omega·\rho}^(R)}}{\sigma·\omega·\rho} |
