...
> a source says how often it announces itself and how big it is, and nothing else. What is it worth, per unit of the face it announces through, to everything around it?
...
| theory | answer |
|---|---|
| `G` | m̄\paren{R̄} = \frac{2·l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·\paren{1 - \rho}·R̄^(D - 1)·\paren{1 - l.reach\paren{R̄}}}{\rho·l.shell\paren{R̄}} |
