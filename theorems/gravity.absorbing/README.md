...
| theory | answer |
|---|---|
| `G` | what a body is open to = \frac{2·l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A'·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄')}}{\rho} |

## G

### the result

**what a body is open to = \frac{2·l.choose\paren{m̄_x·l.DEG·\paren{1 - \beta}}·A'·\paren{1 - \paren{1 - \frac{\rho}{2}}^(R̄')}}{\rho}**
