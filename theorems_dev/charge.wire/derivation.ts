...
export const THEOREM = "charge.wire";
export const ASKS = "the same sign, spreading from a source that is a LINE rather than a point. How much of it is at one site?";
export const UNDER = {
  "theory": "G",
  "geometry": "fcc-12",
  "D": 3,
