 ...
 *
 * charge.falloff, for G on fcc-12
...
export const THEOREM = "charge.falloff";
export const ASKS = "the rays carry a sign, transport keeps it, and a round source puts out a net of it. How much of it is at one site, a distance away?";
export const UNDER = {
  "theory": "G",
  "geometry": "fcc-12",
  "D": 3,
